'''
Author: czj
Date: 2021-05-10 17:25:05
LastEditors: czj
LastEditTime: 2021-05-10 20:36:27
Description:
'''
# -*- coding:utf-8 -*-
import requests
...
"""
从www.bqkan8.com笔趣阁爬取小说，
"""

if __name__=='__main__':
    #所要爬取的小说主页，每次使用时，修改该网址即可，同时保证本地保存根路径存在即可
    target="https://www.bqkan8.com/19_19251/"
    # 本地保存爬取的文本根路径
    save_path = './'
    #笔趣阁网站根路径
    index_path='https://www.bqkan8.com'
    ...
    list_tag=soup.find_all(name='div',attrs={"class":"listmain"})
    ...
    for dd_tag in list_tag[0].dl.find_all('dd'):
        ...
        #解析出来正文所在的标签
        content_tag = chapter_soup.find("div", attrs={"class":"content"})
        #获取正文文本，并将空格替换为换行符
